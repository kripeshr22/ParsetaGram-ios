...
- (void)viewDidLoad;
- (IBAction)onSubmit:(id _Nonnull)sender;
- (IBAction)onCameraButton:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC9Instagram11CommentCell")
...
SWIFT_CLASS("_TtC9Instagram18FeedViewController")
@interface FeedViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
- (void)viewDidLoad;
- (void)keyboardwillbeHiddenWithNote:(NSNotification * _Nonnull)note;
...
- (void)viewDidLoad;
- (IBAction)onSignIn:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC9Instagram17PostTableViewCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified captionLabel;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
